  ...
  return (
    <div className={classes.root}>
      <AppBar className={classes.backgroundColor} position="static">
        ...
        <Button color="inherit" className={classes.buttonColors}><Link style = {{textDecoration: "none", color: "#f8c20e"}} exact to ="/main/names">Names</Link></Button>
          ...
          <Button color="inherit"  className={classes.buttonColors}><Link style = {{textDecoration: "none", color: "#f8c20e"}} exact to ="/main/spells">Spells</Link></Button>
